...
class TextThemeRender<T> extends StatelessWidget {
  ...
  Map<String, String> toCode() {
    return {
    'default': """TextTheme(
       headline1: ${this.headline1?.toCode()},
       headline2: ${this.headline2?.toCode()},
       headline3: ${this.headline3?.toCode()},
       headline4: ${this.headline4?.toCode()},
       headline5: ${this.headline5?.toCode()},
       headline6: ${this.headline6?.toCode()},
       subtitle1: ${this.subtitle1?.toCode()},
       subtitle2: ${this.subtitle2?.toCode()},
       bodyText1: ${this.bodyText1?.toCode()},
       bodyText2: ${this.bodyText2?.toCode()},
       caption: ${this.caption?.toCode()},
       button: ${this.button?.toCode()},
       overline: ${this.overline?.toCode()},
       display4: ${this.display4?.toCode()},
       display3: ${this.display3?.toCode()},
       display2: ${this.display2?.toCode()},
       display1: ${this.display1?.toCode()},
       headline: ${this.headline?.toCode()},
       title: ${this.title?.toCode()},
       subhead: ${this.subhead?.toCode()},
       subtitle: ${this.subtitle?.toCode()},
       body2: ${this.body2?.toCode()},
       body1: ${this.body1?.toCode()},
    )""",
    };
  }
