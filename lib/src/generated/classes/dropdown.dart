...
class DropdownButtonFormFieldRender<T> extends StatelessWidget {
  ...
  Map<String, String> toCode() {
    ...
    'default': """DropdownButtonFormField(
       ...
       selectedItemBuilder: ${this.selectedItemBuilder?.toCode()},
       value: ${this.value?.toCode()},
       hint: ${this.hint?.toCode()},
       disabledHint: ${this.disabledHint?.toCode()},
