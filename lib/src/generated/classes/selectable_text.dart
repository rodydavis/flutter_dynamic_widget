...
class SelectableTextRender<T> extends StatelessWidget {
  ...
  Map<String, String> toCode() {
    ...
    'default': """SelectableText(
       ...
       textScaleFactor: ${this.textScaleFactor?.toCode()},
       ...
       textHeightBehavior: ${this.textHeightBehavior?.toCode()},
       textWidthBasis: ${this.textWidthBasis?.toCode()},
       onSelectionChanged: ${this.onSelectionChanged?.toCode()},
    )""",
    'rich': """SelectableText.rich(
       key: ${this.key?.toCode()},
       focusNode: ${this.focusNode?.toCode()},
