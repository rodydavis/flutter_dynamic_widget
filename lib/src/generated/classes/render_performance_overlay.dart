...
class RenderPerformanceOverlayBase extends BaseWidget {
    RenderPerformanceOverlayBase();

    factory RenderPerformanceOverlayBase.fromJson(Map<String, dynamic> data) {
        return RenderPerformanceOverlayBase();
    }
