...
class MaterialAppRender<T> extends StatelessWidget {
  ...
  Map<String, String> toCode() {
    ...
    'default': """MaterialApp(
       key: ${this.key?.toCode()},
       navigatorKey: ${this.navigatorKey?.toCode()},
       home: ${this.home?.toCode()},
       routes: ${this.routes?.toCode()},
       initialRoute: ${this.initialRoute?.toCode()},
       onGenerateRoute: ${this.onGenerateRoute?.toCode()},
       onGenerateInitialRoutes: ${this.onGenerateInitialRoutes?.toCode()},
       onUnknownRoute: ${this.onUnknownRoute?.toCode()},
       navigatorObservers: ${this.navigatorObservers?.toCode()},
       builder: ${this.builder?.toCode()},
       title: ${this.title?.toCode()},
       onGenerateTitle: ${this.onGenerateTitle?.toCode()},
       color: ${this.color?.toCode()},
       theme: ${this.theme?.toCode()},
       darkTheme: ${this.darkTheme?.toCode()},
       highContrastTheme: ${this.highContrastTheme?.toCode()},
       highContrastDarkTheme: ${this.highContrastDarkTheme?.toCode()},
       themeMode: ${this.themeMode?.toCode()},
       locale: ${this.locale?.toCode()},
       localizationsDelegates: ${this.localizationsDelegates?.toCode()},
       localeListResolutionCallback: ${this.localeListResolutionCallback?.toCode()},
       localeResolutionCallback: ${this.localeResolutionCallback?.toCode()},
       supportedLocales: ${this.supportedLocales?.toCode()},
       debugShowMaterialGrid: ${this.debugShowMaterialGrid?.toCode()},
       showPerformanceOverlay: ${this.showPerformanceOverlay?.toCode()},
       checkerboardRasterCacheImages: ${this.checkerboardRasterCacheImages?.toCode()},
       checkerboardOffscreenLayers: ${this.checkerboardOffscreenLayers?.toCode()},
       showSemanticsDebugger: ${this.showSemanticsDebugger?.toCode()},
       debugShowCheckedModeBanner: ${this.debugShowCheckedModeBanner?.toCode()},
       shortcuts: ${this.shortcuts?.toCode()},
       actions: ${this.actions?.toCode()},
    )""",
    'router': """MaterialApp.router(
       key: ${this.key?.toCode()},
       routeInformationProvider: ${this.routeInformationProvider?.toCode()},
       routeInformationParser: ${this.routeInformationParser?.toCode()},
       routerDelegate: ${this.routerDelegate?.toCode()},
       backButtonDispatcher: ${this.backButtonDispatcher?.toCode()},
       builder: ${this.builder?.toCode()},
       title: ${this.title?.toCode()},
       onGenerateTitle: ${this.onGenerateTitle?.toCode()},
       color: ${this.color?.toCode()},
