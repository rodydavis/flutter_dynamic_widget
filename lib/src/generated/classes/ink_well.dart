...
class InkWellRender<T> extends StatelessWidget {
  ...
  Map<String, String> toCode() {
    ...
    'default': """InkWell(
       ...
       onTapDown: ${this.onTapDown?.toCode()},
       onTapCancel: ${this.onTapCancel?.toCode()},
       onHighlightChanged: ${this.onHighlightChanged?.toCode()},
       onHover: ${this.onHover?.toCode()},
       ...
       splashFactory: ${this.splashFactory?.toCode()},
       ...
       canRequestFocus: ${this.canRequestFocus?.toCode()},
       onFocusChange: ${this.onFocusChange?.toCode()},
