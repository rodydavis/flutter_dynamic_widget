...
abstract class _$AppBarThemeBase extends PropertyBase {
  ...
  String shouldCapTextScaleForTitleKey = 'shouldCapTextScaleForTitle';
  ...
  Map<String, String> get properties => {
        ...
        'shouldCapTextScaleForTitle': 'bool',
      };
  ...
  bool get shouldCapTextScaleForTitleVal {
    if (params[shouldCapTextScaleForTitleKey] != null) {
      return params[shouldCapTextScaleForTitleKey] as bool;
    }
    return false;
  }

  set shouldCapTextScaleForTitleVal(bool val) {
    params[shouldCapTextScaleForTitleKey] = val;
    widgetContext.onUpdate(id, widgetData);
  }
