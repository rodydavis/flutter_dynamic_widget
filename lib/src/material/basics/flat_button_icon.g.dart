...
abstract class _$FlatButtonIconBase extends WidgetBase {
  ...
  void iconValUpdate(Map<String, dynamic> val) {
    final _data = val;
    _data['id'] = 'VvOB8j122NK';
    if (_data['name'] == 'Text') {
      _data['params']['style']['id'] = 'aoy7wlmYwPr';
    }
    if (_data['name'] == 'Icon') {
      _data['params']['0']['id'] = 'yj2bnYtXOXx';
    }
  ...
  void labelValUpdate(Map<String, dynamic> val) {
    final _data = val;
    _data['id'] = 'VWuJr7Izfx4';
    if (_data['name'] == 'Text') {
      _data['params']['style']['id'] = 'jlPObWDcMGS';
    }
    if (_data['name'] == 'Icon') {
      _data['params']['0']['id'] = 'kGY7UCRjG78';
    }
