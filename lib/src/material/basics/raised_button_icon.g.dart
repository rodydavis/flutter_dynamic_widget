...
abstract class _$RaisedButtonIconBase extends WidgetBase {
  ...
  void iconValUpdate(Map<String, dynamic> val) {
    final _data = val;
    _data['id'] = '37x5-OeHU9f';
    if (_data['name'] == 'Text') {
      _data['params']['style']['id'] = '13RwXoRpmxk';
    }
    if (_data['name'] == 'Icon') {
      _data['params']['0']['id'] = 'zU6g7wM4XmP';
    }
  ...
  void labelValUpdate(Map<String, dynamic> val) {
    final _data = val;
    _data['id'] = 'K2o71Ie5yfK';
    if (_data['name'] == 'Text') {
      _data['params']['style']['id'] = 'hjGIVTjPCcV';
    }
    if (_data['name'] == 'Icon') {
      _data['params']['0']['id'] = 'grtRKzfim6K';
    }
