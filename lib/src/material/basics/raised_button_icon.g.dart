...
abstract class _$RaisedButtonIconBase extends WidgetBase {
  ...
  void iconValUpdate(Map<String, dynamic> val) {
    final _data = val;
    _data['id'] = 'XMiNwLzwfjL';
    if (_data['name'] == 'Text') {
      _data['params']['style']['id'] = '_OHUx-Zz1gx';
    }
    if (_data['name'] == 'Icon') {
      _data['params']['0']['id'] = 'pwrotCzYBKG';
    }
  ...
  void labelValUpdate(Map<String, dynamic> val) {
    final _data = val;
    _data['id'] = 'RgrZNP9cCiN';
    if (_data['name'] == 'Text') {
      _data['params']['style']['id'] = 'r2E4OUPbHD1';
    }
    if (_data['name'] == 'Icon') {
      _data['params']['0']['id'] = 'WTUn5Lr9RpQ';
    }
