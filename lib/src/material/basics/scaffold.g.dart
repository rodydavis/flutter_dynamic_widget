...
abstract class _$ScaffoldBase extends WidgetBase {
  ...
  void bottomSheetValUpdate(Map<String, dynamic> val) {
    ...
    _data['id'] = 'OtdXQC-Ur';
    if (_data['name'] == 'Text') {
      _data['params']['style']['id'] = 'D-ckaC5Ijw';
    }
    if (_data['name'] == 'Icon') {
      _data['params']['0']['id'] = '7HI_pFaWmC';
    }
  ...
  void drawerValUpdate(Map<String, dynamic> val) {
    ...
    _data['id'] = '9xNUWJq1No';
    if (_data['name'] == 'Text') {
      _data['params']['style']['id'] = 'rmK27GHWPU';
    }
    if (_data['name'] == 'Icon') {
      _data['params']['0']['id'] = '1NmnZtx2aP';
    }
  ...
  void endDrawerValUpdate(Map<String, dynamic> val) {
    ...
    _data['id'] = 'VgFizcuFQB';
    if (_data['name'] == 'Text') {
      _data['params']['style']['id'] = 'yh6R28Dp3I';
    }
    if (_data['name'] == 'Icon') {
      _data['params']['0']['id'] = 'XbvgKoDTJo';
    }
  ...
  void appBarValUpdate(Map<String, dynamic> val) {
    ...
    _data['id'] = 'ke8Zu4cj7g';
    if (_data['name'] == 'Text') {
      _data['params']['style']['id'] = 'PPHoPKql3e';
    }
    if (_data['name'] == 'Icon') {
      _data['params']['0']['id'] = 'BiJrdS5A2v';
    }
  ...
  void bodyValUpdate(Map<String, dynamic> val) {
    ...
    _data['id'] = 'zugsZcmpjT';
    if (_data['name'] == 'Text') {
      _data['params']['style']['id'] = 'MlnX-5wj3T';
    }
    if (_data['name'] == 'Icon') {
      _data['params']['0']['id'] = '2p__fFZGfg';
    }
  ...
  void bottomNavigationBarValUpdate(Map<String, dynamic> val) {
    ...
    _data['id'] = 'Y9VvyuUeS6';
    if (_data['name'] == 'Text') {
      _data['params']['style']['id'] = 'MuPvprn8Sei';
    }
    if (_data['name'] == 'Icon') {
      _data['params']['0']['id'] = 'No4DmbPL3dt';
    }
  ...
  void floatingActionButtonValUpdate(Map<String, dynamic> val) {
    final _data = val;
    _data['id'] = 'UxxxbI37MwX';
    if (_data['name'] == 'Text') {
      _data['params']['style']['id'] = 'VkKP7g5rEbe';
    }
    if (_data['name'] == 'Icon') {
      _data['params']['0']['id'] = 'K_DZZO3J4DQ';
    }
